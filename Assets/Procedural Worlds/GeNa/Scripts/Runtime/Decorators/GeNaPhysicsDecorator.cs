...
namespace GeNa.Core
{
    ...
    public class GeNaPhysicsDecorator : GeNaDecorator
    {
        ...
        public override IEnumerator OnSelfSpawned(Resource resource)
        {
            ...
            m_settings.m_physicsScene = new PhysicsScene();

            var oldScene = spawnProgress.scene;

            SceneManager.MoveGameObjectToScene(spawnProgress, previewScene);
            ...
            SceneManager.MoveGameObjectToScene(spawnProgress, oldScene);
